...
import com.kdmanalytics.toif.cesel.CeselParser;
...
public class CeselAdaptor extends AbstractAdaptor {
	...
	public ArrayList<Element> parse(java.io.File process,
		...
		try {
			...
			Thread stderr;
			final CeselParser parser = new CeselParser(getProperties(),
